...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table Registerdb(id integer primary key AUTOINCREMENT,name text , FatherName text , phone text, email text UNIQUE, password text,gender text )");
